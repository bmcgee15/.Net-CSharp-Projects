...
/// 
/// Purpose:  This program reads the employee.txt data file and stores the information into a list of
...
{
    /// <summary>
    /// The main method reads the data file, populates the Employee list and provides a menu of sort options.
    /// </summary>
    ...
    static void Main(string[] args)
    {
        ...
        List<Employee> employees = new List<Employee>(); // The list of Employee objects
    ...
    {
        Console.Clear();
        Console.WriteLine("Employee              Number    Rate  Hours  Gross Pay           Bret's Company");
        Console.WriteLine("====================  ======  ======  =====  =========           --------------");
    ...
    /// <summary>
    /// This method reads the data file and stores all of the employee information in an list of Employees
    /// </summary>
    /// <param name="employees">The list of employees</param>
    /// <param name="count">How many employees are in use</param>
